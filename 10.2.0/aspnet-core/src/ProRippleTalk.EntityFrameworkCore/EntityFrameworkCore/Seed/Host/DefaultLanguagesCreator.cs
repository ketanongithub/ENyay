...
public class DefaultLanguagesCreator
{
    ...
    {
        var tenantId = ProRippleTalkConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
    ...
    public DefaultLanguagesCreator(ProRippleTalkDbContext context)
    {
        _context = context;
    }
