...
public abstract class ProRippleTalkWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static ProRippleTalkWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(ProRippleTalkWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<ProRippleTalkDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<ProRippleTalkDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<ProRippleTalkDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<ProRippleTalkDbContext, Task<T>> func)
    {
        T result;
